...
textInput('xlab', 'X axis label', value = "") ,
    ...
    checkboxInput('identityline', 'Identity Line')       
        ...
        tabPanel("How To",
                 h5("1. Upload your data file in CSV format. R default options for read.csv will apply. A common problem is when your missing data slot is not the default and then columns will be treated as factors."),
                 ...
                 h5("4. The UI is dynamic and changes depending on your choices of options, x ,y, filter, group and so on."),
                 ...
                 h5("9. Download the plot using the options on the 'Download' tab. This section is based on code from Mason DeCamillis ggplotLive app."),
                 h5("10. Visualize the data table in the 'Data' tab. You can reorder the columns, filter and much more."),
                 h5("11. Contact me for feedback/Bugs/features requests !"),
                p(),
...
checkboxInput('ignoregroupqr', 'Ignore Group Above'),
